      ...
      _export("Player", Player = (_dec = ccclass('Player'), _dec2 = property(Node), _dec3 = property(Prefab), _dec4 = property(Prefab), _dec5 = property({
        ...
        createOneBullet() {
          ...
          return _asyncToGenerator(function* () {
            ...
            bullet.setPosition(_this.node.position.x, 80, _this.node.position.z);
        ...
        createTwoBullet() {
          ...
          return _asyncToGenerator(function* () {
            ...
            bullet1.setPosition(_this2.node.position.x - 35, 35, _this2.node.position.z);
            bullet2.setPosition(_this2.node.position.x + 30, 35, _this2.node.position.z);
